  ...
  return (
    <div className="relative flex-1 min-h-0">
      ...
      <button onClick={goToMyLocation}
        className="absolute bottom-20 right-4 z-10 bg-white rounded-full p-3 shadow-lg border border-gray-100">
        <LocateFixed size={20} className="text-orange-500" />
      </button>

      <button onClick={() => setShowAddModal(true)}
        className="absolute bottom-20 left-4 z-10 bg-orange-500 text-white rounded-full px-4 py-2.5 shadow-lg flex items-center gap-1.5 text-sm font-medium">
        <Plus size={16} />
        식당 등록
      </button>
